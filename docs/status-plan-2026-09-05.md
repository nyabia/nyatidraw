...
**2026-09-06 재개:** 색상 경계와 4K Undo 타일 재사용에 이어 페이지 크기 변경,
작품 레이어 삭제·Undo의 전체 복원 경로를 설치판 Save/정상 종료/재시작과 독립
tile/PNG 비교로 확인했다. 상세 결과는 문서 끝과 ADR-0031을 따른다. 다음은 남은
history CPU 복사 비용과 UI thread surface 대기다. 아래 최초 점검 표의 미완료
